...
export function InboxPage() {
  const { hilos, unreadCount, isLoading, error, refetch } = useInbox();
        ...
        {hilos.map((hilo, i) => (
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <p style={{
                margin: '2px 0 0', fontSize: 12, color: 'var(--outline)',
                overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap',
              }}>
                {hilo.ultimo_mensaje}
              </p>
            ...
            <span className="material-symbols-outlined" style={{ fontSize: 18, color: 'var(--outline)', flexShrink: 0, alignSelf: 'center' }}>
              chevron_right
            </span>
          </Link>
        ))}
