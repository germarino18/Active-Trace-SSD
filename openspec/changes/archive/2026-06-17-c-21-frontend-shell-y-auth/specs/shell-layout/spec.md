...
The system SHALL show or hide sidebar menu items based on the current user's roles and permissions.
...
- **WHEN** a user has no matching permissions for any menu item in a group
- **THEN** that menu group header SHALL be hidden
