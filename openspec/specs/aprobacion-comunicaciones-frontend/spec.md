...
- **THEN** el sistema llama al endpoint de aprobación, el lote desaparece de la lista de pendientes y se muestra un mensaje de éxito
...
- **THEN** el sistema llama al endpoint de cancelación, el lote desaparece de la lista y se muestra un mensaje de confirmación
